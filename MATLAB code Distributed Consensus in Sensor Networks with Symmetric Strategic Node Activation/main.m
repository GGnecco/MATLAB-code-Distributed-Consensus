%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% MATLAB code for the work "Distributed Consensus in Sensor
% Networks with Symmetric Strategic Node Activation"
% 
...
legend(legend_string,'FontSize',10,'Location','Northwest','interpreter','latex');
