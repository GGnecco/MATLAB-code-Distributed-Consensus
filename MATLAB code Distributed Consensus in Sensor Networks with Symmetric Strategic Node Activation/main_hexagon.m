...
legend('expected global cost for zero unit activation cost $\delta(p)$','expected total cost of activation $k n p$','sum $\delta(p) + k n p$','Location','Northwest','FontSize',14,'interpreter','latex');
